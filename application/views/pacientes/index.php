                                ...
                                if (isset($hospital))
                                    if (!empty($hospital)) {
                                        foreach ($hospital as $c) {
                                            ?>
                                            <tr>
                                                <td><input type='text' class='form-control prioridad number obligatorio' name='prioridad[]' value="<?php echo $c->prioridad ?>"> </td>
                                                <td>
...
<script>
    ...
    $('#agregar_contacto2').click(function() {
        ...
        if (info2.length == 6) {
            var html = "<tr>";
            html += "<td><input type='text' class='form-control prioridad number obligatorio' name='prioridad[]' ></td>";
    ...
    $('body').delegate('.prioridad', 'change', function() {
        ...
        if (r > 1) {
            alerta('rojo', 'Prioridad ya registrada');
            $(this).val('')
        }
    });
