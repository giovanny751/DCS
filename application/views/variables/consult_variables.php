    ...
    <div>
        <div class="row">                <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" value="<?php echo (isset($post['variable_codigo']) ? $post['variable_codigo'] : '' ) ?>" class="form-control   " id="variable_codigo" name="variable_codigo">
                <br>
            </div>
                ...
                <script>
                    $('document').ready(function() {
                        $('#descripcion').autocomplete({
                            source: "<?php echo base_url("index.php//Variables/autocomplete_descripcion") ?>",
                            minLength: 3
                        });
                    });
                </script>
...
<div class="row">
    <div class="col-md-12" style="float:right">
        <a href="<?php echo base_url() . "/index.php/Variables/index" ?>" class="btn btn-dcs" >Nuevo</a>
    </div>
</div>
<?php if (isset($campo)) { ?>
