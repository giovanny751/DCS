...
<form action="<?php echo base_url('index.php/') . "/Clientes/save_clientes"; ?>" method="post" onsubmit="return campos()"  enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-md-3">
            <?php echo lista("id_tipo_cliente", "id_tipo_cliente", "form-control ", "tipo_cliente", "id_tipo_cliente", "descripcion", (isset($datos[0]->id_tipo_cliente) ? $datos[0]->id_tipo_cliente : '' ), array("ACTIVO" => "S"), /* readOnly? */ false); ?>
