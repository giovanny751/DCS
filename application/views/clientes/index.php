...
<h1>Clientes</h1>
<form action="<?php echo base_url('index.php/') . "/Clientes/save_clientes"; ?>" method="post" onsubmit="return campos()">
    <div>
        <div class="row">
        ...
        <div class="row">
            <span id="boton_guardar">
                ...
                <a href="<?php echo base_url('index.php') . "/Clientes/consult_clientes" ?>" class="btn btn-success">Listado </a>
            </span>
